  ...
  return (
    <div className="pos-metrics" role="status">
      <div className="pos-metrics__item">
        <span className="pos-metrics__label">{t('pos.shiftSales')}</span>
        <strong>{fmt(metrics.sales)}</strong>
      </div>
      <div className="pos-metrics__item">
        <span className="pos-metrics__label">{t('common.invoices')}</span>
        <strong>{metrics.invoiceCount}</strong>
      </div>
      <div className="pos-metrics__item">
        <span className="pos-metrics__label">{t('pos.avgOrder')}</span>
