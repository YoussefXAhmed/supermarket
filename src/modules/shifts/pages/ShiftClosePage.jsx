...
export default function ShiftClosePage() {
  ...
  if (!canCloseShift) {
    return (
      <FormPageLayout>
        <PageHeader title={t('shifts.closeShift')} subtitle={t('common.accessDenied')} dense />
        <ApiErrorCard message={t('shifts.noPermissionClose')} />
      </FormPageLayout>
    );
  }
  ...
  return (
    <FormPageLayout>
      <PageHeader
        ...
        subtitle={t('shifts.closeSubtitle')}
        dense
        actions={
