...
export default function InvoicesPage() {
  ...
  return (
    <TablePageLayout tableConstrain={sparse}>
      <PageHeader title={t('invoices.title')} subtitle={t('invoices.subtitle')} dense />
